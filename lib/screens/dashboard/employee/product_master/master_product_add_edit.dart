...
class AddUpdateProductArguments {
  // SearchDetails editModel;

  ProductModel editModel;
  AddUpdateProductArguments(this.editModel);
}

class GeneralProductAddEdit extends StatefulWidget {
  static const routeName = '/GeneralProductAddEdit';

  final AddUpdateProductArguments arguments;

  GeneralProductAddEdit(this.arguments);

  @override
  State<GeneralProductAddEdit> createState() => _CustomerAddEditState();
}

class _CustomerAddEditState extends State<GeneralProductAddEdit> {
  bool _obscuredText = true;

  ProductModel _editModel;
  ...
  AddUpdateCustomer() async {
    ...
    if (_isForUpdate == true) {
      ProductModel UpdatecustomerModel = ProductModel(
          edt_ProductName.text,
          edt_UnitPrice.text,
          edt_Specification.text,
          edt_Unit.text,
      ...
      ProductModel customerModel = ProductModel(
          edt_ProductName.text,
          edt_UnitPrice.text,
          edt_Specification.text,
          edt_Unit.text,
      ...
      await OfflineDbHelper.getInstance().insertGeneralProduct(customerModel);
    }
