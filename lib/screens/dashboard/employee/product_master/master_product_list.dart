...
class GeneralProductListScreen extends StatefulWidget {
  static const routeName = '/GeneralProductListScreen';

  const GeneralProductListScreen({Key key}) : super(key: key);

  @override
  State<GeneralProductListScreen> createState() =>
      _GeneralProductListScreenState();
}

class _GeneralProductListScreenState extends State<GeneralProductListScreen> {
                ...
                child: ButtonBar(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        onTap: () {
                          navigateTo(context, GeneralProductAddEdit.routeName,
                                  arguments: AddUpdateProductArguments(model))
                              .then((value) {
                            getDetails();
                          });
                        },
