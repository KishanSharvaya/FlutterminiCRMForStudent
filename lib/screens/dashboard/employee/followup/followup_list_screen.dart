...
class _FollowupListScreenState extends State<FollowupListScreen> {
  List<FollowupModel> arr_CustomerList = [];
  List<FollowupModel> temparr_CustomerList = [];
  ...
  void getDetails() async {
    ...
    arr_CustomerList = await OfflineDbHelper.getInstance().getAllFollowup();
    temparr_CustomerList = await OfflineDbHelper.getInstance().getAllFollowup();
    setState(() {});
  }

  Widget Items(int index) {
    FollowupModel model = arr_CustomerList[index];
                ...
                child: ButtonBar(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        onTap: () {
                          navigateTo(context, FollowupAddEdit.routeName,
                                  arguments: AddUpdateFollowupArguments(model))
                              .then((value) {
                            getDetails();
                          });
                        },
  ...
  void SearchResult(String enteredKeyword) {
    List<FollowupModel> dummySearchList = [];
    dummySearchList.addAll(arr_CustomerList);
    if (enteredKeyword.isNotEmpty) {
      List<FollowupModel> dummyListData = [];
